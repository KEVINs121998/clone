...
const Footer = () => {
  return (
    <div className='text-white'>
        <footer className="flex justify-center  footer footer-center py-10 bg-base-200 text-base-content rounded bottom-0 relative  pl-56">
        <div>
      <p> All Right Reserved ©Copyright 2023 </p>
    </div>
    <div className="grid grid-flow-col gap-10 pl-72 pr-24">
      <a className="link link-hover cursor-pointer">Terms of Service</a> 
      <a className="link link-hover cursor-pointer">Privacy Policy</a> 
      <a className="link link-hover cursor-pointer">Product</a> 
    </div> 
    <div>
